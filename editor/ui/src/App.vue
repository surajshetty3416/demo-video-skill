<template>
  <div class="flex h-full flex-col bg-surface-base text-ink-gray-8">
    ...
    >
      ...
      <span class="text-sm text-ink-gray-5">{{ ui.seg }}</span>
...
import { Button, Dropdown, Tooltip, ToastProvider, toast } from "frappe-ui";
...
async function renderSegment() {
  if (await engine.startRender([ui.seg], false)) toast.info(`Rendering ${ui.seg}…`);
}
